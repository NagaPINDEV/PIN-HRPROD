CREATE TABLE [hr].[stg_tblcdmdepartment] (
    [cdm_departmentid]           UNIQUEIDENTIFIER NULL,
    [cdm_departmentnumber]       NVARCHAR (MAX)   NULL,
    [cdm_description]            NVARCHAR (MAX)   NULL,
    [cdm_name]                   NVARCHAR (MAX)   NULL,
    [cdm_parentdepartmentid]     UNIQUEIDENTIFIER NULL,
    [cdm_parentdepartmentidname] NVARCHAR (MAX)   NULL,
