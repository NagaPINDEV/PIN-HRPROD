CREATE TABLE [hr].[stg_tblcdmworkerpersonidentificationtype] (
    [cdm_allowedvalues]                    INT              NULL,
    [cdm_countryregion]                    NVARCHAR (MAX)   NULL,
    [cdm_description]                      NVARCHAR (MAX)   NULL,
    [cdm_fixedlength]                      INT              NULL,
    [cdm_identificationnumberformat]       NVARCHAR (MAX)   NULL,
    [cdm_name]                             NVARCHAR (MAX)   NULL,
    [cdm_type]                             INT              NULL,
    [cdm_workerpersonidentificationtypeid] UNIQUEIDENTIFIER NULL,
