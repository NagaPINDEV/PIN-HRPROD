CREATE TABLE [hr].[stg_tblcdmpositionworkerassignment] (
    [cdm_careertrack_custom]             INT              NULL,
    [cdm_isprimaryposition]              BIT              NULL,
    [cdm_jobpositionid]                  UNIQUEIDENTIFIER NULL,
    [cdm_jobpositionidname]              NVARCHAR (MAX)   NULL,
    [cdm_positionworkerassignmentmapid]  UNIQUEIDENTIFIER NULL,
    [cdm_positionworkerassignmentnumber] NVARCHAR (MAX)   NULL,
