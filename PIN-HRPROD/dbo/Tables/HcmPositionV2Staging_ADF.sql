CREATE TABLE [dbo].[HcmPositionV2Staging_ADF] (
    ...
    [FUNCTION_CUSTOM]              NVARCHAR (75)   NOT NULL,
    [OFFICE_CUSTOM]                NVARCHAR (75)   NOT NULL,
    [TEAM_CUSTOM]                  NVARCHAR (75)   NOT NULL,
    [EEOJOBCLASSIFICATION_CUSTOM]  NVARCHAR (75)   NOT NULL,
    [HISTORICALLINEMANAGER_CUSTOM] NVARCHAR (100)  NOT NULL,
    [TEAMV2_CUSTOM]                NVARCHAR (50)   NOT NULL,
    [SYNCSTARTDATETIME]            DATETIME        NOT NULL,
    [RECID]                        BIGINT          NOT NULL,
    CONSTRAINT [PK_HcmPositionV2Staging_ADF] UNIQUE NONCLUSTERED ([EXECUTIONID] ASC, [POSITIONID] ASC, [PARTITION] ASC)
);
